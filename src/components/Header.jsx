...
export const Header = () => {
  ...
  const handleSubmit = (event) => {
    ...
    event.target.reset();
    return navigate(`/search?q=${field}`);
  };
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id="mobile-dev" className="flex md:order-2 gap-2">
            <button
              ...
              className="flex items-center p-2 mr-1 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
            >
              {darkMode ? (
                <svg
                  aria-hidden="true"
